...
for scenenum = 1:length(scenenames)
    ...
    %%% DUMMY CODE -- will be replaced with your complete matching etc.%%%%
     ...
     matchComparison(im1, im2, f1, f2, d1, d2, n1, 0.75, 0.55, 1e-10, 4000);
     % Last 4 parameters are found through Grid Search. See marchComparison
     % and gridSearch files for details
