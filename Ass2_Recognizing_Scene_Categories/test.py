...
deploy_prototxt_file_path = '/work/04441/mkshah/files/train_val.prototxt' # Network definition file
caffe_model_file_path = '/work/04441/mkshah/files/ss_Alex_extra_iter_9000.caffemodel' # Trained Caffe model file
test_lmdb_path = '/work/04441/mkshah/files/scene_test_lmdb/' # Test LMDB database path
mean_file_binaryproto = '/work/04441/mkshah/files/scene_mean.binaryproto' # Mean image file
